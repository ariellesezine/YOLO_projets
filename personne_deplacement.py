...
#cap = cv2.VideoCapture('sezine.mp4')#"http://10.163.207.107:8080/video"
...
while True :
    ...
    classIDs = []
    Areas=[]
    window_name='suivi des deplacements de personnes sur une video'
        ...
        for detection in output:
            ...
            if confidence>DEFAULT_CONFIDENCE :
                ...
                if len(Areas)>3 and area>Areas[-3]:
                    output="une personne s'approche de vous"
                    print("-----------------------------------------------------")
                elif len(Areas)>3 and area<Areas[-3]:
                    output="la personne s'eloigne de vous"
                else:
                    output=" "
